...
class TestValidateArguments:
    ...
    def test_parses_extended_thinking_arguments(self):
        """Test that extended thinking arguments are parsed correctly."""
        # Arrange
        parser = setup_argparse()
    ...
    def test_extended_thinking_help_text(self):
        """Test that extended thinking help text is correct."""
        # Arrange
        parser = setup_argparse()

        # Act & Assert
        # Just verify that the parser can be created without errors
        # The help text is automatically generated by argparse and we can see it's working from the other tests
...
class TestExtractLlmCredentials:
    ...
    def test_extracts_all_credentials_from_args(self):
        ...
        args.claude_extended_thinking = True
        args.claude_thinking_budget = 8192
    ...
    def test_uses_environment_variable_when_arg_is_none(self):
        ...
        args.claude_model = 'claude-3-sonnet'
        args.claude_extended_thinking = False
        args.claude_thinking_budget = None
        args.endpoint = None
        args.api_key = None
        ...
        assert result['claude_extended_thinking'] == False
        assert result['claude_thinking_budget'] is None
